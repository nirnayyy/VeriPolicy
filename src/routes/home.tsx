...
function MarketingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className={`marketing-navbar-wrapper fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${
        showNavbar ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 -translate-y-5 pointer-events-none"
      }`}>
        <Navbar />
      </div>
